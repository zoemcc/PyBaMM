...
sol = pickle.load(open("compare.p", "rb"))
...
if run == True:
    ...
    sim_truth = pybamm.Simulation(model_truth, var_pts=pts(70), solver=solver)
    sim_truth.solve()
    ...
    pickle.dump(out, open("compare2.p", "wb"))
